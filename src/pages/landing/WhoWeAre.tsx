...
const WhoWeAre = (props: Props) => {
    return (
        <div className='bg-gray-100 p-3 md:p-0 grid grid-cols-1 md:grid-cols-2 place-items-center h-full md:h-[600px] w-full'>
            <div>
            ...
            <div>
                ...
                <p className=' text-[#575757] leading-7 w-full md:w-[510px] text-[16px] mt-3'>
                    At Ctrl Tech Academy, we are passionate about empowering individuals with the knowledge
