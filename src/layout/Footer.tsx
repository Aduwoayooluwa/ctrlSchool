            ...
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <ul className="mt-8 text-[15px] flex gap-6">
                            <li>
                                <a
                                    href="/"
                                    rel="noreferrer"
                    ...
                    >
                        <div>
                            <p className="font-semibold text-gray-900">Useful Links</p>
                        ...
                        <div>
                            <p className="font-semibold text-gray-900">Our Courses</p>
                        ...
                        <div>
                            <p className="font-semibold text-gray-900">More Links</p>
